...
partial model PartialSingleZone
  ...
  outer FastBuildings.Input.BaseClasses.Partial_SIM simFasBui
    "Weather data, to be provided by an inner submodel of Partial_SIM"                                                           annotation(Placement(visible = true, transformation(origin = {-90.1538, 89.5214}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
