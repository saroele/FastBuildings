...
model SZ_Inputs_powEle_Ventilation
  ...
  HVAC.Ventilation_Profile ventilation_Profile
...
equation
  connect(simFasBui.powEle,use.powEle) annotation(Line(points={{-86.193,78.5462},
          {-86,78.5462},{-86,-40},{-38.3051,-40},{-38.3051,-40.6577}}));
  ...
  connect(zon.TZon, ventilation_Profile.TZon) annotation (Line(
      points={{-19.0598,-7.65812},{-19.0598,-8},{0,-8},{0,26},{7.6422,26},{
          7.6422,25.9659}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(zon.heaPorCon, ventilation_Profile.heaPorCon) annotation (Line(
      points={{-19.0598,0.34188},{-6,0.34188},{-6,34},{8.017,34},{8.017,34.0068}},

      color={191,0,0},
      smooth=Smooth.None));
  connect(simFasBui.qHeaCoo, hva.qHeaCoo) annotation (Line(
      points={{-82.193,78.5462},{-82.193,58},{48,58},{48,16},{2,16},{2,8.72124},
          {8.0938,8.72124}},
      color={0,0,127},
      smooth=Smooth.None));
