...
model SZ_Inputs_powEle_qVen_qHeaCoo_qEmb
  extends SZ_Inputs_with_partials(redeclare replaceable FastBuildings.HVAC.Heating_qHeaCoo_qEmb hva);
...
end SZ_Inputs_powEle_qVen_qHeaCoo_qEmb;