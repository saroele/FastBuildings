...
model Z2_Inputs "2-zone building, with HVAC read from inputs"
  extends FastBuildings.Buildings.BaseClasses.Partial2Zone(redeclare FastBuildings.HVAC.Heating_Input hva1, redeclare FastBuildings.HVAC.Heating_Input hva2, bou(r = 1e-3, c = 1e6));
equation
