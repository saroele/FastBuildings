...
model Sim_Ven
  ...
  inner FastBuildings.Input.SIM_Inputs_QHeaCoo_QEmb simFasBui annotation(Placement(visible = true, transformation(origin = {-82, 84}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Buildings.SZ_Inputs_powEle_qVen_qHeaCoo_qEmb bui(redeclare FastBuildings.Zones.ZonInt_A zon(rWal = 1e-3, rInt = 1e-5, cInt = 1e7, cZon = 1e8), ven.mFloVen = 1, redeclare FastBuildings.HVAC.Heating_Input hva) annotation(Placement(visible = true, transformation(origin = {2, 32}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
