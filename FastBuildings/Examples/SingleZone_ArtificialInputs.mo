...
model SingleZone_ArtificialInputs
  ...
  Buildings.SZ_Inputs_powEle_Ventilation_TSup bui(redeclare
      FastBuildings.Zones.ZonWalInt_A                                                  zon(cZon = 1000000.0, cInt = 10000000.0, cWal = 10000000, rWal = 0.001, rInt = 0.01)) annotation(Placement(visible = true, transformation(origin = {28.1699, 29.7255}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
