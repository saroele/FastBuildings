...
package Examples "Examples and test models"
  ...
  model SingleZone_Inputs_Distr_defined "Single zone simulation based on inputs for QHeaCoo and PEle"
    ...
    FastBuildings.Buildings.SZ_Inputs_powEle bui(
      redeclare FastBuildings.Zones.ZonInt_B zon(cZon = 1e6, cInt = 1e7, rInt = 1e-2),
      redeclare FastBuildings.HVAC.Heating_Distribution hva(cHea = 1e5)) annotation(Placement(visible = true, transformation(origin = {28.1699, 29.7255}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  end SingleZone_Inputs_Distr_defined;
end Examples;
