...
model GB_QSet_Eta_full
  "Gas boiler with  QSet end eta as function of TAmb, TSup and PFue"
  ...
  */
  ...
  Real eta =  Intercept +
              ...
              TAmb7_Q86000 * (TAmb_7 * Q_86000) +
              TSup35_Q86000 * (TSup_35 * Q_86000) +
              TAmb7_TSup35_Q86000 * (TAmb_7 * TSup_35 * Q_86000);
