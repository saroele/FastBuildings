...
model HP_AW_QSet_COP_TAmb_TSup "Air-water heat pump with QSet and COP based on TAmb and TSup"
  ...
  Real COP = COP_0 + fTAmb * (simFasBui.TAmb - (7 + 273.15)) + fTSup * (heaPorHot.T - (35 + 273.15));
