...
model HP_AW_QSet_COP_TAmb_TSupInput
  "Air-water heat pump with QSet and COP based on TAmb and TSup as input"
  ...
  Modelica.Blocks.Interfaces.RealInput TSup
    annotation (Placement(transformation(extent={{-126,12},{-86,52}})));
equation
  PEle * COP = QSet;
  PFuel = 0;
