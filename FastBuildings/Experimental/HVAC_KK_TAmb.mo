...
model HVAC_KK_TAmb "Total HVAC model for KK"
  ...
  Zones.BaseClasses.Capacitor capTecRoo(c = cTecRoo) annotation(Placement(transformation(extent = {{-16, 56}, {4, 36}})));
...
equation
  ...
  connect(simFasBui.TAmb, preTAmb.T) annotation(Line(points = {{-79.193, 81.5462}, {-70, 81.5462}, {-70, 82}, {-60, 82}, {-60, 60}, {-55.2, 60}, {-55.2, 60}}, color = {0, 0, 127}, smooth = Smooth.None));
  ...
  connect(resLos.heaPor_b, capTecRoo.heaPor) annotation(Line(points = {{2, 60}, {-6, 60}, {-6, 56}}, color = {191, 0, 0}, smooth = Smooth.None));
