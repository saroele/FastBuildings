...
model PrescribedTemperature_and_Flux
  "Variable temperature and flux boundary condition "

  HT.Interfaces.HeatPort_b port annotation (Placement(transformation(extent={{90,
