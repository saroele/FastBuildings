...
partial model Partial_HVAC
  Modelica.Blocks.Interfaces.RealInput TZon annotation(Placement(visible = true, transformation(origin = {-103.578, -80.3407}, extent = {{-12, -12}, {12, 12}}, rotation = 0), iconTransformation(origin = {-103.578, -80.3407}, extent = {{-12, -12}, {12, 12}}, rotation = 0)));
