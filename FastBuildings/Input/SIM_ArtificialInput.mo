...
model SIM_ArtificialInput "Dummy weather and inputs "
  ...
  Modelica.Blocks.Sources.Step qHea(height = 1000, startTime = 86400) annotation(Placement(visible = true, transformation(origin = {54.3799, -81.39870000000001}, extent = {{-6.3799, -6.6013}, {6.3799, 6.6013}}, rotation = 0)));
  Modelica.Blocks.Math.Max max1 annotation(Placement(visible = true, transformation(origin = {65.59520000000001, -12.2887}, extent = {{-5.59521, -5.71125}, {5.59521, 5.71125}}, rotation = 0)));
  ...
  Modelica.Blocks.Sources.Constant const1(k = 273.15 + 20) annotation(Placement(visible = true, transformation(origin = {-13.3019, -77.4166}, extent = {{-4.6981, -4.5834}, {4.6981, 4.5834}}, rotation = 0)));
  Modelica.Blocks.Sources.Pulse day(period = 86400, startTime = 25000, amplitude = 1, width = 60) annotation(Placement(visible = true, transformation(origin = {-51.3886, -37.648}, extent = {{-6.61139, -6.35201}, {6.61144, 6.352}}, rotation = 0)));
