...
model SIM_ArtificialInput "Dummy weather and inputs "
  ...
  Modelica.Blocks.Sources.Constant const1(k = 273.15 + 20) annotation(Placement(visible = true, transformation(origin={-13.3019,
            -77.4166},                                                                                                    extent = {{-4.6981,-4.5834},{4.6981,4.5834}}, rotation = 0)));
  Modelica.Blocks.Sources.Pulse day(
    period=86400,
    startTime=25000,
    amplitude=1,
    width=60) annotation (Placement(visible=true, transformation(
        origin={-51.3886,-37.648},
        extent={{-6.61139,-6.35201},{6.61144,6.352}},
        rotation=0)));
  Modelica.Blocks.Math.Product product1
    annotation (Placement(transformation(extent={{-36,-54},{-26,-44}})));
  Modelica.Blocks.Sources.Pulse wee(
    amplitude=1,
    width=5/7*100,
    period=7*86400,
    startTime=0) annotation (Placement(visible=true, transformation(
        origin={-51.3886,-59.648},
        extent={{-6.61139,-6.35201},{6.61144,6.352}},
        rotation=0)));
equation
  ...
  connect(const1.y,TSet) annotation(Line(points={{-8.13399,-77.4166},{-0.5,
          -77.4166},{-0.5,-104.427}},                                                                   color = {0,0,127}, smooth = Smooth.None));
  connect(day.y, product1.u1) annotation (Line(
      points={{-44.116,-37.648},{-40,-37.648},{-40,-46},{-37,-46}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(wee.y, product1.u2) annotation (Line(
      points={{-44.116,-59.648},{-42,-59.648},{-42,-52},{-37,-52}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(product1.y, prf[1]) annotation (Line(
      points={{-25.5,-49},{-22,-49},{-22,-62},{-40.5,-62},{-40.5,-104.427}},
      color={0,0,127},
      smooth=Smooth.None));
...
into your model to specify your Simulation Input Manager.", Icon(coordinateSystem(extent = {{-100,-100},{100,100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2,2})), Diagram(coordinateSystem(extent={{-100,
