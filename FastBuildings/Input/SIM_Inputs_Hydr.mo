...
model SIM_Inputs_Hydr "SIM with inputs from filereaders or other means and hydraulic heating"
  ...
  /* 
                              ...
                              */
  Modelica.Blocks.Interfaces.RealOutput TSupBoi1;
  Modelica.Blocks.Interfaces.RealOutput TRetBoi1;
  Modelica.Blocks.Interfaces.RealOutput TSupBoi2;
  Modelica.Blocks.Interfaces.RealOutput TRetBoi2;
  Modelica.Blocks.Interfaces.RealOutput fraCoo;
  Modelica.Blocks.Interfaces.RealOutput stateBoi1 "0-1";
  Modelica.Blocks.Interfaces.RealOutput stateBoi2 "0-1";
  Modelica.Blocks.Interfaces.RealOutput qHea;
  Modelica.Blocks.Interfaces.RealOutput qCoo;
