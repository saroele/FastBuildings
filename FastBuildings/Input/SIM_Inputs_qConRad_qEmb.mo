...
model SIM_Inputs_qConRad_qEmb "SIM with inputs from filereaders or other means"
    ...
    Modelica.Blocks.Interfaces.RealOutput qConRad "Convective/radiative heating/cooling" annotation(Placement(visible = true, transformation(origin = {55, -104}, extent = {{-10, -10}, {10, 10}}, rotation = 270), iconTransformation(origin = {79.6078, -109.752}, extent = {{-10, -10}, {10, 10}}, rotation = 270)));
