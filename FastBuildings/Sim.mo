...
model Sim
  ...
  Buildings.SZ_Inputs_powEle_qVen bui(redeclare FastBuildings.Zones.ZonInt_A zon(rWal = 1e-3, rInt = 1e-5, cInt = 1e7, cZon = 1e8), ven.mFloVen = 1) annotation(Placement(visible = true, transformation(origin = {2, 32}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
