...
model powEleFra
  ...
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a heaPorRad annotation(Placement(visible = true, transformation(origin = {99.86960000000001, -39.6349}, extent = {{-12, -12}, {12, 12}}, rotation = 0), iconTransformation(origin = {99.86960000000001, -39.6349}, extent = {{-12, -12}, {12, 12}}, rotation = 0)));
equation
