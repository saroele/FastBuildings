...
model powEleFra_Occ
  "Separate inputs for electricity consumption(in W) and occupancy profile (0-1), parameter for powEle"

  parameter Real fraCon = 0.7
    "Fraction of electrical power and metabolic gains that is converted in convective heat";
  parameter Real nOcc = 1
    "Number of occupants at full occupancy (when pfrOcc=1)";
  parameter Real fraPowEle = 1
    "Fraction of powEle that is converted into internal gains";
  parameter SI.HeatFlowRate metabolism = 100
    "Total sensitive heat gain per person";
  ...
  Modelica.Blocks.Interfaces.RealInput prfOcc annotation (Placement(
      visible=true,
      transformation(
        origin={-106.128,60.2608},
        extent={{-12,-12},{12,12}},
        rotation=0),
      iconTransformation(
        origin={-106.128,0.260756},
        extent={{-12,-12},{12,12}},
        rotation=0)));
...
equation
  ...
  annotation(Icon, Diagram(coordinateSystem(preserveAspectRatio=false, extent={{
