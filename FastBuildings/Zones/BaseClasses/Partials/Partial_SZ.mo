...
partial model Partial_SZ "Single zone partial model, no air node"
  ...
  Modelica.Blocks.Interfaces.RealOutput TZon
    "Zone temperature. Most often this will be air temperature"                                          annotation(Placement(transformation(extent = {{96, -90}, {116, -70}}), iconTransformation(extent = {{90, -90}, {110, -70}})));
  outer Input.BaseClasses.Partial_SIM simFasBui
    "Input data, to be provided by an inner submodel of PartialSIM"                                             annotation(Placement(transformation(extent = {{-200, 80}, {-180, 100}})));
  annotation(Diagram(coordinateSystem(extent = {{-200, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2}), graphics), Icon(coordinateSystem(extent = {{-200, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2}), graphics={  Polygon(origin = {0.130719, 0.130719}, points = {{-200.131, 99.8693}, {-200.131, -40.1307}, {-60.1307, -40.1307}, {-60.1307, -100.131}, {99.8693, -100.131}, {99.8693, 99.8693}, {-200.131, 99.8693}})}));
end Partial_SZ;
