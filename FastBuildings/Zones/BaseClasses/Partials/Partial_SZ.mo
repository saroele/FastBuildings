...
partial model Partial_SZ "Single zone partial model, no air node"
  ...
  HT.Interfaces.HeatPort_b heaPorEmb "Heat transfer to embedded systems, like tabs" annotation(Placement(visible = true, transformation(origin = {100, 39.9057}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, 39.9057}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
