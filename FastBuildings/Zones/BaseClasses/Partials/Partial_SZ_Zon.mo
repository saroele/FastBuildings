...
partial model Partial_SZ_Zon "Single state, only zone temperature, array of windows"
  ...
  replaceable Windows.Window_gA[nIrr] win constrainedby Windows.PartialWindow "Array of window models" annotation(Placement(transformation(extent = {{-100, 30}, {-80, 50}})));
  BaseClasses.Resistance resWal(r = rWal) "Total thermal resistance of the walls, in K/W" annotation(Placement(transformation(extent = {{-100, -10}, {-80, 10}})));
protected
