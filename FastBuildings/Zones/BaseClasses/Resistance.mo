...
equation
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}), graphics), Icon(graphics={  Text(rotation = 0, lineColor = {0, 0, 255}, fillColor = {0, 0, 0}, pattern = LinePattern.Solid,
            ...
            lineThickness =                                                                                                    0.25, extent = {{-133.961, 98.90300000000001}, {126.039, 47.903}}, textString = "%name"), Line(points = {{-100, 0}, {100, 0}}, color = {95, 95, 95}, smooth = Smooth.None), Rectangle(extent = {{-80, 20}, {80, -20}}, lineColor = {95, 95, 95}, fillColor = {95, 95, 95},
