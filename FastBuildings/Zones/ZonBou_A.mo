...
model ZonBou_A "Single state, only zone temperature, array of windows, with boundary temperature"
...
equation
  ...
  connect(simFasBui.TSet, preTBou.T) annotation(Line(points = {{-190.039, 79.0248}, {-190.039, -40}, {-185.2, -40}}, color = {0, 0, 127}, smooth = Smooth.None));
