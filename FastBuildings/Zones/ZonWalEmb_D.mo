...
model ZonWalEmb_D "incl. ground, heaPorRad connected to capWal, no infiltration"
  extends ZonWalEmb_A;
...
equation
  connect(resGro.heaPor_a, capEmb.heaPor) annotation(Line(points = {{-20, -80}, {-20, -26}, {60, -26}, {60, 60}}, color = {191, 0, 0}, smooth = Smooth.None));
