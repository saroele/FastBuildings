...
model ZonEmb_B "States for zone and embedded heating, heaPorRad to capEmb"
  extends FastBuildings.Zones_stochastic.BaseClasses.Partials.Partial_SZ_ZonEmb;
equation
  ...
  connect(heaPorRad, capEmb.heaPor) annotation(Line(points = {{100, -40}, {60, -40}, {60, 60}}, color = {191, 0, 0}, smooth = Smooth.None));
